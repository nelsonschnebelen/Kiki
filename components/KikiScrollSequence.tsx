    ...
    >
      ...
      <div ref={stageRef} className="kiki-stage relative h-[100svh] w-full overflow-hidden">
        ...
        <p
          ref={noteRef}
          aria-hidden
          className="script pointer-events-none absolute right-[4vw] top-[5svh] hidden rotate-[-8deg] text-right text-[30px] leading-[0.95] text-cobalt opacity-0 xl:text-[34px]"
        >
