...
interface ParallaxBandProps {
  ...
  height?: string;
  /** Kept for callers; notes are no longer drawn on bands (hero only). */
  note?: string[];
 ...
 */
export default function ParallaxBand({ image, alt, height = "62svh", focus = "50% 50%", dim = false, className = "", children }: ParallaxBandProps) {
